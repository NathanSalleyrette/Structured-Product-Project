...
public:
     ...
     */
    void pAndL(int nbHedgeDate, double &errorHedge, PnlMat *marketData, double valLiqRef, std::vector<double>& spots, std::vector<double>& prices, std::vector<double>& dates);
